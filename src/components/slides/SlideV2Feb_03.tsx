...
/* Feb 2026 LVMH: Hublot 7, LV 7, Zenith 6, TAG Heuer 2, Bvlgari 2, Dior 2, Tiffany 1 */
interface BrandRow { name: string; count: number; logo: string }

const BRANDS: BrandRow[] = [
    { name: 'Hublot', count: 7, logo: LOGO_HUBLOT },
    { name: 'Louis Vuitton', count: 7, logo: LOGO_LV },
    { name: 'Zenith', count: 6, logo: LOGO_ZENITH },
    { name: 'TAG Heuer', count: 2, logo: LOGO_TAG },
    { name: 'Bvlgari', count: 2, logo: LOGO_BVLGARI },
...
export function SlideV2Feb_03() {
    return (
        <div className="v2-slide">
            ...
            <p className="v2-subtitle" style={{ top: 213 + 100 * 0.93 + 11 }}>LVMH FEB 2026 [TOP 7 BRANDS]</p>
